...
class GeneralImageDataset(Dataset):
    def __init__(self, dataset, transform, target_transform=None, common_transforms=None):
...
class MatDataFromFolder(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.common_transform is not None:
            mat = self.common_transform(mat)
        # mat SHOULD be a torch tensor here
        return mat, mat.clone().detatch()
